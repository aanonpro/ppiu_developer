 ...
 <nav class="main-header navbar navbar-expand navbar-default navbar-light" style="background-color: rgb(231, 231, 231);">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        {{-- logout  --}}
        <div class="dropdown">
            <button class="btn dropdown-toggle text-dark" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->name }}
            </button>
